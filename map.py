...
def help():
  ...
  print "ifind <REGEX>        find in the database all the label that match <REGEX> without Case Sensitive "
  print "ifindbr <REGEX>      find in the current branch all the label that match <REGEX> without Case Sensitive "
